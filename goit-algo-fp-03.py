...
DG.remove_edges_from([("Ринок Анжеліка", "Склад"),
                     ("Авангард", "Ринок Анжеліка"), ("Ринок 7км", "Авангард")])

# Застосування алгоритму PageRank для визначення ступіню вершини
...
sorted_list_degree_centrality = sorted(
    list_degree_centrality.items(), key=lambda x: x[1], reverse=True)
for node, rank in sorted_list_degree_centrality:
    print(f'{node}: {round(rank, 4)}')
print(" ")
print("Betweenness: ")
list_betweenness = nx.betweenness_centrality(DG)
sorted_list_betweenness = sorted(
    list_betweenness.items(), key=lambda x: x[1], reverse=True)
for node, rank in sorted_list_betweenness:
    print(f'{node}: {round(rank, 4)}')
print(" ")
print("Closenness: ")
list_closenness = nx.closeness_centrality(DG)
sorted_list_closenness = sorted(
    list_closenness.items(), key=lambda x: x[1], reverse=True)
...
print(" ")
print("Найкоротші шляхи від вузла 'Склад' до всіх інших вузлів:")
print(shortest_paths)

print(" ")
# виведе довжини найкоротших шляхів від вузла 'A' до всіх інших вузлів
print("Довжини найкоротших шляхів від вузла 'Склад' до всіх інших вузлів: ")
print(shortest_path_lengths)


plt.figure(figsize=(6, 6))
pos = nx.spring_layout(DG, seed=42)
nx.draw_networkx(DG, pos, with_labels=True, node_size=400,
